...
class Property:
    ...
    def unmortgage(self):
        """Lift the mortgage on this property and return the redemption cost."""
...
class PropertyGroup:
    """Represents a colour group on the board."""
    ...
    def get_owner_counts(self):
        """Return a map of owners to how many properties they hold in this group."""
        counts = {}
